...
import MembersTab from "../features/groups/presentation/screens/MembersTab";
...
export default function StudentTabsNavigator() {
  return (
    <Tab.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Tab.Screen name="Courses" component={CategoriesWrapper} />

    
      <Tab.Screen name="Members" component={MembersTab} />

      <Tab.Screen name="Results" component={HomeScreen} />
